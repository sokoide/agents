...
| `17_スプライト.md` | PCG/SAT配置、SP_CTRLビットフィールド、仮想SATダブルバッファリング、V-Sync同期（3手法） |
| `18_実践ゲーム制作.md` | 共通ヘッダ、アラインメント制限、動的オブジェクト管理、例外ハンドリング（trap 14） |
| `19_elf2x68kクロス開発.md` | elf2x68k環境特有の問題、IOCS raw trap必須、関数番号一覧、256色モードGVRAM、CRTCスクロール |
